        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo Config::get('URL') ?>dashboard/index">Unlimited - Admin</a>
                </div>
                ...
                <ul class="nav navbar-nav navbar-left navbar-top-links">
                    <li><a href="<?php echo Config::get('URL') ?>index/index"><i class="fa fa-home fa-fw"></i> Website</a></li>
                </ul>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo Config::get('URL') ?>dashboard/index"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                            </li>
